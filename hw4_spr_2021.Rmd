...
```{r, results=T}
fit.exhaustive.final <- glm(HD~AGE+SEX+SBP+CHOL+FRW+CIG, family=binomial, data=hd_data.f)
summary(fit.exhaustive.final)
```
...
fit.exhaustive.predict <- predict(fit.exhaustive.final, hd_data.new, type="response")
fit.exhaustive.predict
